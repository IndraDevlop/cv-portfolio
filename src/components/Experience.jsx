...
export default function Experience() {
  ...
  const nodePositionsVertical = [
    { cx: 120, cy: 130 },   // Node 1
    { cx: 50, cy: 1200 },   // Node 2
    { cx: 190, cy: 2210 },  // Node 3
  ];
  ...
  return (
    <div ref={containerRef} id="experience" className="relative w-full overflow-hidden mt-25 py-10">
      <h1 className="text-center text-4xl font-bold mb-1">Experience</h1>
      <p className="text-base/loose text-center opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Below are some of the projects I have worked on</p>
      ...
      <div className="absolute top-[150px] md:top-[50px] left-0 w-full pointer-events-none md:hidden">
        <motion.svg
          width="100%"
          height={isMobile ? 500 : 300}
          viewBox={isMobile ? "0 0 300 2300" : "0 0 2300 300"}
        ...
        {experiences.map((item, i) => (
          <motion.div
            ...
            className={`relative top-0 left-0 w-[90vw] sm:w-[240px] max-w-[350px] min-h-[180px] bg-zinc-800 shadow-xl border border-zinc-700 rounded-2xl p-6 text-left flex-shrink-0 xl:min-w-[270px] lg:w-[150px] lg:min-w-[190px] md:w-[160px] md:min-w-[100px] sm:p-6
              ${i === 0 ? "sm:left-[136px] sm:top-[90px] md:left-[45px] md:top-[-80px] lg:left-[45px] lg:mt-[-74px] lg:top-0 xl:top-[5px] xl:left-[170px] 2xl:top-[10px] 2xl:left-[120px]" : ""}
              ${i === 1 ? "sm:left-[-152px] sm:top-[-50px] md:left-[0px] md:top-[-123px] lg:left-[-10px] lg:top-[-133px] xl:top-[-142px] xl:left-[-10px] 2xl:top-[-152px] 2xl:left-[0px]" : ""}
              ${i === 2 ? "sm:left-[150px] sm:top-[-110px] md:left-[-15px] md:top-[-62px] lg:left-[-25px] lg:top-[-51px] xl:top-[-40px] xl:left-[-140px] 2xl:top-[-27px] 2xl:left-[-50px]" : ""}
            `}
          >
